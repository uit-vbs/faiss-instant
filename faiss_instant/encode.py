...
def run(
    ...
    if ngpus:
        ...
        print("WARNING: Using cpu. It is going to be slow")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--normalize",
        action="store_true",
        help="Set this flag if cosine-similarity will be used",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=32,
        help="Batch size per GPU device. If no GPU, it is for the total CPU batch size",
    )
